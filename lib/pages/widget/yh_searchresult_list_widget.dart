...
import 'package:yhmoble/common/utils/common_utils.dart';
import 'package:yhmoble/common/utils/screen_util.dart';
import 'package:yhmoble/model/search.dart';

class YHSearchResultListWidget extends StatelessWidget {
  final SearchResultListModal list;
  final ValueChanged<String> onItemTap;
  final VoidCallback getNextPage;

  YHSearchResultListWidget(this.list, {this.onItemTap, this.getNextPage});
    ...
    return list.data.length == 0
        ...
        : ListView.builder(
            ...
            itemBuilder: (BuildContext context, int i) {
              ...
              return Container(
                color: YHColors.searchAppBarBgColor,
...
//                        )
                    ...
                    Expanded(
                      ...
                      decoration: BoxDecoration(
                          border: Border(
                              bottom: BorderSide(
                                  width: 1, color: YHColors.divideLineColor))),
                      child: Column(
