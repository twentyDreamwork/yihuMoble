...
import 'package:yhmoble/model/tab.dart';

class YHTabBarWidget extends StatefulWidget implements PreferredSizeWidget {
  final List<TabModel> tabModels;
  final TabController tabController;
  final int currentIndex;
  const YHTabBarWidget(
      {Key key, this.tabModels, this.tabController, this.currentIndex})
      : super(key: key);

  @override
  _YHTabBarWidgetState createState() => _YHTabBarWidgetState();
...
class _YHTabBarWidgetState extends State<YHTabBarWidget> {
//  get preferredSize {
