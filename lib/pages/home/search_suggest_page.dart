...
//                    color: randomColor(),
                          ...
                          child: Text(
                            i,
                            style: TextStyle(
                                color: Color(0xFF565757), fontSize: 13),
                          )),
                    ))
                .toList(),
          ),
          ...
          Row(
            children: <Widget>[
              ...
              GestureDetector(
                ...
                child: Icon(
                  _isHideSearchFind ? Icons.slideshow : Icons.highlight,
                  color: Colors.grey,
                  size: 16,
                ),
              ),
                    ...
                    return GestureDetector(
                      onTap: () {
                        NavigatorUtils.gotoSearchGoodsResultPage(
                            context, searchHintTexts[index]);
                      },
                      child: Container(
                        child: Text(
                          searchHintTexts[index],
                          style:
                              TextStyle(fontSize: 13, color: Color(0xFF565757)),
                        ),
                      ),
                    );
                  }, growable: false),
