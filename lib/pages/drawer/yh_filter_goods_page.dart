...
class YHFilterGoodsPage extends StatefulWidget {
  @override
  _YHFilterGoodsPageState createState() => _YHFilterGoodsPageState();
}

class _YHFilterGoodsPageState extends State<YHFilterGoodsPage> {
...
//              padding: EdgeInsets.only(left: 6, right: 6, top: 6),
              decoration: BoxDecoration(
                  color: YHColors.mainBackgroundColor,
...
//      color: Colors.red,
                border: Border(
                    bottom: BorderSide(
                        width: 1, color: YHColors.mainBackgroundColor)))),
      ],
    );
  }
